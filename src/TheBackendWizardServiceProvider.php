...
class TheBackendWizardServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->publishes([
            ...
            __DIR__. '/Modules/Setup/components' => $pathManager->specificPathExtract($pathManager::$VIEW_COMPONENT_PATH), //view component files
            __DIR__. '/Modules/Setup/component-class' => $pathManager->specificPathExtract($pathManager::$COMPONENT_CLASS_PATH), //view component class files
