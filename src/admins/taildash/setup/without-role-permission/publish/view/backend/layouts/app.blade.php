<!DOCTYPE html>
<html lang="en" dir="{{$theme_setting->direction}}" class="{{$theme_setting->color_scheme}}">
...
<body class="font-sans {{$theme_setting->primary_color}} text-base font-normal text-gray-600 bg-gray-100 dark:text-gray-400 dark:bg-black">
    <!-- wrapper -->
